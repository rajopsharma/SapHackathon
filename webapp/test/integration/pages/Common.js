sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/bcone/hackathon/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.bcone.hackathon.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/bcone/hackathon/localService/mockserver"], function (mockserver) {
